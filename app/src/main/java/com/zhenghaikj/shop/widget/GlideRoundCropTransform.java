...
*/
public class GlideRoundCropTransform extends BitmapTransformation {

    private static float radius = 0f;

    public GlideRoundCropTransform(Context context) {
        this(context, 4);
    }

    public GlideRoundCropTransform(Context context, int dp) {
