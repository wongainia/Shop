...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            Log.e("FingerDemo","Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    Log.e("FingerDemo"," Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            Log.e("FingerDemo"," Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            Log.e("FingerDemo"," Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
