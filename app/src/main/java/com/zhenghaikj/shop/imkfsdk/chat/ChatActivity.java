package com.zhenghaikj.shop.imkfsdk.chat;
...
import com.zhenghaikj.shop.imkfsdk.chat.adapter.ChatAdapter;
import com.zhenghaikj.shop.imkfsdk.constant.Constants;
import com.zhenghaikj.shop.imkfsdk.recordbutton.AudioRecorderButton;
import com.zhenghaikj.shop.imkfsdk.utils.FaceConversionUtil;
import com.zhenghaikj.shop.imkfsdk.utils.FileUtils;
import com.zhenghaikj.shop.imkfsdk.utils.PermissionUtils;
import com.zhenghaikj.shop.imkfsdk.utils.PickUtils;
import com.zhenghaikj.shop.imkfsdk.utils.ToastUtils;
import com.zhenghaikj.shop.imkfsdk.view.ActionSheetDialog;
import com.zhenghaikj.shop.imkfsdk.view.ChatListView;
import com.zhenghaikj.shop.imkfsdk.view.TcpExitDiaglog;
...
//        //是否配置了满意度
    ...
    public void updateMessage() {
        ...
        chatAdapter = new ChatAdapter(ChatActivity.this, descFromToMessage,listener);
...
//                        this.getResources().getString(R.string.exitchat),
    ...
    public void startReStartDialog2() {
        singleButtonDialog = builder.setMessage("")
                ...
                .setSingleButton("重新接入", 0xFF459ae9, new OnClickListener() {
                    @Override
    ...
    public void startReStartDialog3() {
        singleButtonDialog = builder.setMessage("")
                ...
                .setSingleButton("退出", 0xFF459ae9, new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        singleButtonDialog.dismiss();
                        IMChatManager.getInstance().quitSDk();
